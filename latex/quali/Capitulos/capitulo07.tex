...
Há também uma relação menos influente entre o número de ocorrências de uma determinada estrutura secundária nas trincas e a proporção de acertos dessa trinca para a mesma estrutura secundária (Figura \ref{fig:occ_acerto}).
...
\label{my-label}
\begin{tabular}{lllll}
Probabilidade acertos X & coil & hélice & fita &  \\
Proporção na SS         & 0,75 & 0,60   & 0,60 &  \\
Ocorrencias na SS       & 0,60 & 0,24   & 0,38 &  
\end{tabular}
\end{table}
